...
from ....dialects.linalg import LinalgOpConfig, OperandKind
from ....dialects.linalg.opdsl.lang.dsl import _prepare_structured_op_outs
...
def emit_generic_structured_op(
    ...
    **attrs: Sequence[int],
    ...
    generic_op = dialects.linalg.GenericOp(
...
def emit_named_structured_op(
    ...
    **attrs: Sequence[int],
    ...
    if (
        ...
        or not op_class_name in dialects.linalg.__dict__.keys()
    ):
    ...
    named_op = getattr(dialects.linalg, op_class_name)(ins, outs, result_types)
    ...
    dialects.linalg.fill_builtin_region(named_op.operation)
...
dialects.linalg.opdsl.lang.emitter.emit_named_structured_op = (
...
dialects.linalg.opdsl.lang.dsl.DefinedOpCallable.__call__ = __call__
